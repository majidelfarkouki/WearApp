...
import com.app.wearapp.CustomScrollingLayoutCallback;
import com.app.wearapp.EventChat;
import com.app.wearapp.MessageAdapter;
import com.app.wearapp.RecyclerViewClickListener;
...
public class MessagesList extends WearableActivity implements RecyclerViewClickListener, SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER){
            ...
            if (mAccel > 2) {
                ...
                Toast.makeText(MessagesList.this, "Message list updated",
    ...
    public void recyclerViewListClicked(View v, int position) {
        ...
        Intent intent = new Intent(MessagesList.this, MessageDetails.class);
